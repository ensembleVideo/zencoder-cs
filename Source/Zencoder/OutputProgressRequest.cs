...
namespace Zencoder
{
    ...
    public class OutputProgressRequest : Request<OutputProgressRequest, OutputProgressResponse>
    {
        ...
        public OutputProgressRequest(Zencoder zencoder)
            : base(zencoder)
        {
        }
        ...
        public OutputProgressRequest(string apiKey, Uri baseUrl)
            : base(apiKey, baseUrl)
        {
        }
